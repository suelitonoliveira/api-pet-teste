...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false)
				...
				.select().apis(RequestHandlerSelectors.basePackage("com.petz.resources"))
				.paths(PathSelectors.any()).build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("API Petz", "API REST solução Petz-Teste", "Versão 1.0", "http://www.apiPetz.com",
				new Contact("DEV", "http://www.apiPetz.com", "suelitondeoliveira@gmail.com"), "",
				"http://www.apiPetz.com/terms", Collections.emptyList());
	}
